    ...
    <div class="body_wrap">
      ...
      <!-- slide bar end -->
        ...
        <main>
            ...
            <!-- breadcrumb start -->
            <section class="breadcrumb bg_img d-flex align-items-center" data-overlay="dark-2" data-opacity="7" data-background="./assets/img/gallery/gallery6.jpeg">
                <div class="container">
                    <div class="breadcrumb__content text-center">
                        <h2>Service web</h2>
                        <ul class="bread-crumb clearfix ul_li_center">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item">Service / Web Development</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section class="service-single pt-120 pb-120">
                <div class="container">
                    <div class="row mt-none-30">
                        <div class="col-lg-8 mt-30">
                            <div class="service-single__content">
                                <div class="service-single__thumb mb-30">
                                    <img src="assets/img/web development.jpg" alt="">
                                </div>
                                <h2> Web development</h2>
                                <p>Web development encompasses both front-end and back-end programming, ensuring that websites not only look visually appealing but also function seamlessly. It's a dynamic field that constantly evolves with emerging technologies and user expectations.</p>
                                <!-- <p>Our small, flexible, agile and design-led structures and processes allow us to be highly responsive and innovative. We’re made of passionate leaders, strategists, managers, developers, animators and designers who work together
                                    under one umbrella. </p> -->
                                <div class="service-single__info-wrap mt-50 mb-50">
                                    <div class="service-single__info">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="service-single__info-item">
                                                    <div class="icon">
                                                        <i class="invite-text-gr-color fa fa-star-o"></i>
                                                    </div>
                                                    <div class="content">
                                                        <h4>HTML5</h4>
                                            ...
                                            <div class="cta__btn">
                                              <a href="./assets/register.php" class="thm-btn thm-btn__gradient">
                                                  <span class="btn-anim-wrap">
                                ...
                                <p>With over a decade of experience, we’ve established ourselves as one of the pioneering agencies in the region. Our small, flexible, agile and design-led structures and processes allow us to be highly responsive and innovative.
                                    We’re made of passionate leaders, strategists, managers, developers, animators and designers who work together under one umbrella. We are a digitally-led, full-service creative agency. We combine strategy, marketing,
                                    design.</p> -->
                                <div class="accordion__wrap">
                                    <h3 class="accordion-title">Frequently Asked Question</h3>
                                    <ul class="accordion_box clearfix">
                                        <li class="accordion block">
                                            ...
                                            <div class="acc_body">
                                                <div class="content">
                                                    <b>Web development</b> is a fast-paced and intellectually stimulating career that involves creative problem-solving and continuous innovation. As a web developer, you’ll collaborate with multidisciplinary teams to bring projects to life.                                               </div>
                                            </div>
                                        </li>
                                        <li class="accordion block active-block">
                                            ...
                                            <div class="acc_body current ">
                                                <div class="content">
                                                   <b> Web development</b> involves creating and maintaining websites and web applications. It encompasses tasks like designing, coding, and ensuring a website or app runs smoothly on the internet1. As a web developer, you’ll work on both the <b>front-end (user interface)</b> and <b>back-end (server-side logic)</b> aspects of web projects.                                                </div>
                                            </div>
                                        </li>
                                        <li class="accordion block">
                                            <div class="acc-btn">
                                            ...
                                            <div class="acc_body">
                                                <div class="content">
                                                   <b> Web development</b> involves creating and maintaining websites and web applications. It encompasses tasks like designing, coding, and ensuring a website or app runs smoothly on the internet. Exciting career opportunities in web development include roles such as full-stack developers, UI/UX designers, and front-end or back-end specialists. Find your niche and thrive in this dynamic field!                                                 </div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="widget mt-30">
                                    ...
                                    <div class="widget__inner">
                                        <ul class="widget__category list-unstyled">
                                            <li><a href="./markiting.html">Digital Marketing <i class="fa fa-angle-double-right"></i></a></li>
                                            <li><a href="./ai.html">AI<i class="fa fa-angle-double-right"></i></a></li>
                                            <li><a  class="active"  href="./web.html">Web Development<i class="fa fa-angle-double-right"></i></a></li>
                                            <li><a href="./accounting.html">Accountiong<i class="fa fa-angle-double-right"></i></a></li>
                                            <li><a  href="./ui.html">UI/UX Design<i class="fa fa-angle-double-right"></i></a></li>
                                            <li><a href="./graphic.html">Graphic Design<i class="fa fa-angle-double-right"></i></a></li>
                                            <li><a href="./e-commerce.html">E-Commerce<i class="fa fa-angle-double-right"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="widget mt-30">
                                    <div class="widget__add-banner bg_img" data-background="assets/img/bg/banner_bg.jpg">
                                        <h3>+92 3469210999</h3>
                                        <span>Monday – Saturday: 7:00 am -1:00 <br> pm24/7 Emergency Service</span>
                                        <a href="contact.html" class="thm-btn thm-btn__gradient mt-30">
                                            <span class="btn-anim-wrap">
                                                <span class="button-text">Contact us</span>
                                                <span class="button-text">Contact us</span>
                                            </span>
